...
- **«Общий дашборд»** (`/overview`, `OverviewPage.tsx`, пункт меню у всех ролей, включая Viewer):
  рейтинг по сумме «Готово» и по оценкам ОС, KPI месяца, заказы по дням, загрузка технарей,
