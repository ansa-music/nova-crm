...
export function MyScheduleCard({
  ...
  return (
    <section className="mb-4 flex min-w-0 flex-col gap-3 rounded-xl border border-primary/35 bg-primary/[0.05] p-3 sm:p-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[12px] text-muted-foreground">
            Сегодня {today.date} {MONTH_GEN[today.month]}, {DOW_SHORT[today.dow].toLowerCase()}:{" "}
            {!ready ? (
              "загружаем…"
            ) : (
              <span
