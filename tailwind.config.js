...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      // Шаг 12 для модификатора прозрачности (`bg-primary/12`): в шкале Tailwind
      // его нет, и 19 классов активных чипов, бейджей и плитки «Доступ
      // ограничен» тихо не собирались — элементы оставались без заливки.
      opacity: {
        12: "0.12",
      },
      fontFamily: {
